...
export const BUILT_IN_RENDERER_DESCRIPTORS: RendererDescriptor[] = [
  ...
  },
  {
    ...
    packageUrl: 'https://github.com/bhouston/blender-materialx-importer',
  },
  {
    name: 'blender-nodes',
    category: 'pathtracer',
    sortIndex: 30,
    description: 'Blender MaterialX Importer using patched MaterialX nodes through Cycles',
    packageName: '@material-fidelity/renderer-blender',
    packageUrl: 'https://github.com/bhouston/blender-materialx-importer',
  },
  {
    ...
    category: 'rasterizer',
    sortIndex: 40,
    description: 'Blender MaterialX Importer using patched MaterialX nodes through Eevee',
    packageName: '@material-fidelity/renderer-blender',
    packageUrl: 'https://github.com/bhouston/blender-materialx-importer',
  },
  {
